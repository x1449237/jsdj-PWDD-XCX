...
type Evaluation struct {
	...
	IsAdditional      int8           `gorm:"column:is_additional;not null;default:0" json:"is_additional"`                    // 追加评价
	...
	AdditionalContent string         `gorm:"column:additional_content;type:text" json:"additional_content"`                   // 追评内容
	AdditionalImages  datatypes.JSON `gorm:"column:additional_images" json:"additional_images"`                               // 追评图片
	AdditionalAt      *time.Time     `gorm:"column:additional_at" json:"additional_at"`                                       // 追评时间
	Images            datatypes.JSON `gorm:"column:images" json:"images"`                                                     // 评价截图
