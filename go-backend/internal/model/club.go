...
type Club struct {
	...
	IsVisible             int8       `gorm:"column:is_visible;not null;default:1" json:"is_visible"`                                          // 对外展示开关
	...
	PaymentQRCode         string     `gorm:"column:payment_qr_code;size:512;not null;default:''" json:"payment_qr_code"`                      // 自定义收款码
	BusinessHours         string     `gorm:"column:business_hours;size:64;not null;default:''" json:"business_hours"`                         // 营业时间
	BusinessStart         string     `gorm:"column:business_start;size:8;not null;default:'00:00'" json:"business_start"`                     // 营业开始
	...
	MinRank               string     `gorm:"column:min_rank;size:32;not null;default:''" json:"min_rank"`                                     // 最低段位
	MinCompletedOrders    int        `gorm:"column:min_completed_orders;not null;default:0" json:"min_completed_orders"`                      // 最低完成订单数
	BusinessEnd           string     `gorm:"column:business_end;size:8;not null;default:'23:59'" json:"business_end"`                         // 营业结束
	MinOrderPrice         int64      `gorm:"column:min_order_price;not null;default:0" json:"min_order_price"`                                // 最低接单价格
	InRecruitHall         int8       `gorm:"column:in_recruit_hall;not null;default:0" json:"in_recruit_hall"`                                // 入驻招募大厅
	FounderTransferTo     int64      `gorm:"column:founder_transfer_to;not null;default:0" json:"founder_transfer_to"`                        // 创始人转移目标
	FounderTransferStatus int8       `gorm:"column:founder_transfer_status;not null;default:0" json:"founder_transfer_status"`                // 创始人转移状态
...
type ClubMember struct {
	...
	RoleDetail      int8       `gorm:"column:role_detail;not null;default:0" json:"role_detail"`             // 细化角色 0无 1派单员 2接待
	...
	OnlineStatus    int8       `gorm:"column:online_status;not null;default:0" json:"online_status"`         // 在线状态
	IsBanned        int8       `gorm:"column:is_banned;not null;default:0" json:"is_banned"`                 // 是否禁单
	DailyOrderLimit int        `gorm:"column:daily_order_limit;not null;default:0" json:"daily_order_limit"` // 单日接单上限
	TodayOrderCount int        `gorm:"column:today_order_count;not null;default:0" json:"today_order_count"` // 今日已接单数
	Points          int        `gorm:"column:points;not null;default:0" json:"points"`                       // 俱乐部积分
