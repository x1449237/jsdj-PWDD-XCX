...
type LegalPersonFaceVerify struct {
	...
	Fee               int64      `gorm:"column:fee;not null;default:0" json:"fee"`                                             // 本次认证扣费金额(分),先收费再认证
	PayerUID          int64      `gorm:"column:payer_uid;not null;default:0" json:"payer_uid"`                                 // 付费用户ID(创始人)
