...
type Order struct {
	...
	AcceptDeadline  *time.Time `gorm:"column:accept_deadline" json:"accept_deadline"`                                       // 验收截止时间
	...
	BatchID         string     `gorm:"column:batch_id;size:64;not null;default:''" json:"batch_id"`                         // 批量下单批次ID
	SourceType      int8       `gorm:"column:source_type;not null;default:0" json:"source_type"`                            // 订单归属
	ReceptionistUID int64      `gorm:"column:receptionist_uid;not null;default:0" json:"receptionist_uid"`                  // 接待人ID
	IsAbnormal      int8       `gorm:"column:is_abnormal;not null;default:0" json:"is_abnormal"`                            // 异常订单
	IsArchived      int8       `gorm:"column:is_archived;not null;default:0" json:"is_archived"`                            // 已归档
	MaxAmount       int64      `gorm:"column:max_amount;not null;default:0" json:"max_amount"`                              // 最大金额阈值
